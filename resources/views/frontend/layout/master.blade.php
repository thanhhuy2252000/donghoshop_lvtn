                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="header-top-left">
                                <ul class="phone-wrap">
                                    <li><span>Số liên hệ:</span><a href="#">(+84) 399 xxx xxx</a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <ul class="ht-menu">
                                    ...
                                    <li>
                                        @guest
                                            ...
                                            @else
                                            <div class="ht-setting-trigger"><span>{{$userlog->name}}</span></div>
                                        ...
                                        <div class="setting ht-setting" >
                                            <ul class="ht-setting-list">
                                                ...
                                                @guest
                                                    <li><a href="{{route('userLogin.index')}}">Đăng nhập</a></li>
                                                    <li><a href="{{route('userRegister.index')}}">Đăng ký</a></li>
                                                    @else
                                                    <li><a href="{{route('myAccount.index')}}">Thông tin cá nhân của tôi</a></li>
                                                    <li><a href="{{route('orderList.index')}}">Đơn hàng</a></li>
                                    ...
                                    <!-- Begin AdminPage -->
                                    <li>
                                        <span class="language-selector-wrapper"><a href="{{route('admin.index')}}">AdminPage</a></span>
            ...
            <div class="header-middle pl-sm-0 pr-sm-0 pl-xs-0 pr-xs-0">
                <div class="container">
                    <div class="row">
                        ...
                        <!-- Begin Header Middle Right Area | thanh tìm kiếm -->
                        <div class="col-lg-9 pl-0 ml-sm-15 ml-xs-15">
                            <!-- Begin Header Middle Searchbox Area -->
                            <form action="{{ route('search.result') }}" method="GET" class="hm-searchbox">
                                <input type="text" name="query" placeholder="Tìm sản phẩm hoặc thương hiệu...">
                                        ...
                                        @if (count((array)session('cart'))==0)
                                            <div class="hm-minicart-trigger">
                                                ...
                                                <span class="item-text">
                                                    <span class="cart-item-count">{{count((array)session('cart'))}}</span>
                                                </span>
                                            </div>
                                            <span></span>
                                            <div class="minicart">
                                                ...
                                                <div class="minicart-button">
                                                    ...
                                                    <a href="{{route('checkout.index')}}" class="li-button li-button-fullwidth">
                                                        <span class="checkoutt">Thanh toán</span>
                                                    </a>
                                                </div>
                                            </div>
                                        @else
                                                ...
                                                <ul class="minicart-product-list">
                                                    @if (session('cart'))
                                                        @foreach (session('cart') as $id => $details )
                                                            <li>
                                                                <a href="{{route('productDetail.index',['id'=>$details['id'],'slug' => Str::slug($details['name'])])}}" class="minicart-product-image">
                                                                    <img src="{{asset('backend/img/product/'.$details['img'])}}" alt="cart products">
                                                                </a>
                                                                <div class="minicart-product-details">
                                                                    <h6><a href="{{route('productDetail.index',['id'=>$details['id'],'slug' => Str::slug($details['name'])])}}">{{$details['name']}}</a></h6>
                                                                    <span>
                                                                        @if ($details['giaKM'] != 0 && $details['km_tungay'] <= now() && now() <= $details['km_denngay'])
                                                                        {{number_format($details['giaKM'])}} đ x {{$details['quantity']}}
                                                                        @else
                                                                        {{number_format($details['gia'])}} đ x {{$details['quantity']}}
                                                                        @endif
                                                                    </span>
                                                                </div>
                                                            </li>
                            ...
                            <div class="hb-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="megamenu-holder"><a href="{{ route('search.result', ['query' => 'Thương hiệu']) }}">Thương hiệu</a>
                                        ...
                                        <li><a href="{{ route('search.result', ['query' => 'Nam']) }}">Nam</a></li>
                                        <li><a href="{{ route('search.result', ['query' => 'Nữ']) }}">Nữ</a></li>
                                        <li><a href="{{ route('search.result', ['query' => 'Đồng hồ đôi']) }}">Đồng hồ đôi</a></li>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p>Thanh toán bằng các phương thức thanh toán phổ biến và an toàn nhất Việt Nam.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <ul class="des">
                                        <li>
                                            <span>Address: </span>
                                            180, Cao Lỗ, Ward 4, District 8, Ho Chi Minh, Viet Nam 
                                        </li>
                                        <li>
                                            <span>Phone: </span>
                                            <a href="#">(+84) 399 xxx xxx</a>
                                        </li>
                                        <li>
                                            <span>Email: </span>
                                            <a href="#">dh51804755@student.stu.edu.vn</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="footer-block">
                                        <h3 class="footer-block-title">Theo dõi tôi</h3>
                                        <ul class="social-link">
                                            ...
                                            <li class="facebook">
                                                <a href="https://www.facebook.com/huy0522" data-toggle="tooltip" target="_blank" title="Facebook">
